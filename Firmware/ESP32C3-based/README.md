...
For devices based on the **ESP32-C3 SoC** ([_version 3.3 and later_](../../PCB/3.3/README.md)), firmware is updated automatically using the [BEACON.App] user application.
...
>
> Alternatively, you can use version [1.0](../../PCB/1.0/README.md) and [2.0](../../PCB/2.0/README.md) devices based on ATmega328P with the [wspr-beacon-1.1](../ATmega328P-based/wspr-beacon-1.1/) firmware, which is publicly available. These device versions **do not support [BEACON.App]** and can only be configured by modifying and rebuilding the firmware source code.
