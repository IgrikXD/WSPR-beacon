...
By default, the SI5351 is initialized at I2C address 0x60. If no device is detected at this address, an initialization error is indicated by the LED (_the **red LED (TX)** blinks three times_) and the device subsequently restarts. **If you encounter any problems at this stage - make sure that your SI5351 instance really has I2C address 0x60!** If necessary, you can [change the value of the I2C address of the SI5351](../ATmega328P-based/README.md#i2c-address-of-the-si5351) in the firmware source code.
