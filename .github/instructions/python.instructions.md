...
- Class-level docstrings are required for all classes, including widgets and test modules. Method-level docstrings are required for all public and private methods that perform non-trivial operations.
