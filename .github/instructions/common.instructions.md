...
- **MCP (Model Context Protocol):** Use the MCP plugin to access multiple contexts of information, including project documentation, codebase, and external resources. Always specify the context you are referring to when providing information or asking questions. Available MCP servers:
  ...
  - **GitHub:** Provides access to GitHub repository operations such as managing issues, pull requests, branches, releases, and code search. For any tasks involving GitHub repository interactions, you must use this tool. When creating or updating pull requests and issues, always assign them to the author and apply appropriate [labels](https://github.com/IgrikXD/WSPR-beacon/labels). Refer to [CONTRIBUTING.md](../../CONTRIBUTING.md) for detailed project contribution guidelines, including rules for opening issues, submitting pull requests, branch naming conventions, and code review process.
