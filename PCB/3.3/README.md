...
>
> Alternatively, you can use version [1.0](../1.0/README.md) and [2.0](../2.0/README.md) devices based on ATmega328P with the [wspr-beacon-1.1](../../Firmware/ATmega328P-based/wspr-beacon-1.1/) firmware, which is publicly available. These device versions **do not support [BEACON.App](https://github.com/IgrikXD/WSPR-beacon/blob/master/App/README.md)** and can only be configured by modifying and rebuilding the firmware source code.
