...
The [Firmware](./Firmware/) folder contains software required for the device operation and firmware instructions. The [Schematics](./Schematics/) directory contains the device schematic file in _.pdf_ format. The [Gerbers](./Gerbers/) directory contains files necessary for ordering PCB and side covers [fabrication at the factory](https://pcbway.com). In the [Enclosure-models](./Enclosure-models/) directory you can find files with markup, for milling the side covers of the aluminum enclosure.
